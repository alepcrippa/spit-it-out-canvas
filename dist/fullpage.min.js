  ...
  return zt.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function(e, t) {
    ...
    function(e, E) {
      ...
      if (!Ln(u, Ft)) {
        ...
        p.k = En({}, p.m);
        var g, m, S, w, b, O, M, y, C, H = zt.PointerEvent ? {
            down: "pointerdown",
            move: "pointermove"
          } : {
            down: "MSPointerDown",
        ...
        Ct(), zt.fp_easings = En(zt.fp_easings, {
        ...
        }), d && (h.version = "3.0.8", h.setAutoScrolling = Z, h.setRecordHistory = ee, h.setScrollingSpeed = te, h.setFitToSection = ne, h.setLockAnchors = function(e) {
          E.lockAnchors = e
        }, h.setMouseWheelScrolling = oe, h.setAllowScrolling = re, h.setKeyboardScrolling = le, h.moveSectionUp = ae, h.moveSectionDown = se, h.silentMoveTo = ce, h.moveTo = ue, h.moveSlideRight = fe, h.moveSlideLeft = de, h.fitToSection = xe, h.reBuild = ve, h.setResponsive = he, h.getFullpageData = function() {
          return E
        }, h.destroy = function(e) {
          Z(!1, "internal"), re(!0), ie(!1), le(!1), Nn(d, Yt), [b, w, m, O, M, C, S, P].forEach(function(e) {
            clearTimeout(e)
        ...
        }, zt.fullpage_api = h, E.$ && Object.keys(h).forEach(function(e) {
          E.$.fn.fullpage[e] = h[e]
          ...
          if (!E.anchors.length) {
            ...
            t.length && t.length === yn(qt).length && (V = !0, t.forEach(function(e) {
      ...
      function Z(e, t) {
        ...
        var n = yn(Qt)[0];
        if (E.autoScrolling && !E.scrollBar) Tn(r, {
          overflow: "hidden",
          height: "100%"
      ...
      function he(e) {
        var t = pe();
        e ? t || (Z(!1, "internal"), ne(!1, "internal"), Bn(yn(nn)), Nn(L, Vt), _n(E.afterResponsive) && E.afterResponsive.call(d, e), E.scrollOverflow && g.createScrollBarForAll()) : t && (Z(D.autoScrolling, "internal"), ne(D.autoScrolling, "internal"), Rn(yn(nn)), zn(L, Vt), _n(E.afterResponsive) && E.afterResponsive.call(d, e))
      }
            ...
            E.autoScrolling && E.continuousVertical && void 0 !== d.isMovementUp && (!d.isMovementUp && "up" == d.yMovement || d.isMovementUp && "down" == d.yMovement) && ((p = d).isMovementUp ? Fn(yn(Qt)[0], Zn(p.activeSection, qt)) : Yn(yn(Qt)[0], eo(p.activeSection, qt).reverse()), Tt(yn(Qt)[0].offsetTop), Be(), p.wrapAroundElements = p.activeSection, p.dtop = p.element.offsetTop, p.yMovement = vt(p.element), d = p), d.localIsResizing || Ke(d.activeSection), E.scrollOverflow && E.scrollOverflowHandler.beforeLeave(), Nn(e, Xt), zn(Xn(e), Xt), Ye(e), E.scrollOverflow && E.scrollOverflowHandler.onLeave(), k = h.test.isTesting, bt(f, u, d.anchorLink, d.sectionIndex),
              function(e) {
                ...
                if (E.css3 && E.autoScrolling && !E.scrollBar) {
                  ...
                  var r = Pe(e.dtop);
                  h.test.top = -e.dtop + "px", Ht(r.element, r.options, E.scrollingSpeed, function() {
      ...
      function it(e, t, n) {
        ...
        l.xMovement = (o = l.prevSlideIndex, r = l.slideIndex, o == r ? "none" : r < o ? "left" : "right"), l.direction = l.direction ? l.direction : l.xMovement, l.localIsResizing || (k = !1), E.onSlideLeave && !l.localIsResizing && "none" !== l.xMovement && _n(E.onSlideLeave) && !1 === Ne("onSlideLeave", l) ? a = !1 : (Nn(t, Xt), zn(Xn(t), Xt), l.localIsResizing || (Ke(l.prevSlide), Ye(t)), !E.loopHorizontal && E.controlArrows && (Qn(yn(Sn, i), 0 !== l.slideIndex), Qn(yn(wn, i), null != Cn(t))), Ln(i, Xt) && !l.localIsResizing && bt(l.slideIndex, l.slideAnchor, l.anchorLink, l.sectionIndex), function(e, t, n) {
          ...
          if (E.css3) {
            ...
            h.test.translate3dH[t.sectionIndex] = r, Tn(ut(yn(fn, e)), kt(r)), b = setTimeout(function() {
              n && lt(t)
            }, E.scrollingSpeed)
      ...
      function at() {
        T = !0, clearTimeout(m), m = setTimeout(function() {
      ...
      function gt(e, t) {
        t ? ut(d) : ft(d), Tn(d, kt(e)), h.test.translate3d = e, setTimeout(function() {
          zn(d, Wt)
        }, 10)
      }
      ...
      function xt(e) {
        var t = [];
        return t.y = void 0 !== e.pageY && (e.pageY || e.pageX) ? e.pageY : e.touches[0].pageY, t.x = void 0 !== e.pageX && (e.pageY || e.pageX) ? e.pageX : e.touches[0].pageX, l && Oe(e) && E.scrollBar && void 0 !== e.touches && (t.y = e.touches[0].pageY, t.x = e.touches[0].pageX), t
      }
